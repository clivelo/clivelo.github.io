...
If you take a look at my [GitHub repo](https://github.com/clivelo?tab=repositories) (<i>shameless plug</i>), you will see that I have quite a few projects built using the [p5.js](https://p5js.org/) library. It was my prelude to JavaScript when it was introduced to me by [The Coding Train](https://www.youtube.com/channel/UCvjgXvBlbQiydffZU7m1_aw) (<i>big fan btw!</i>) :train:.
...
It’s a free and open-source library with its own [web editor](https://editor.p5js.org/)! So if you are like me and find it a hassle to choose between all these different web editors and customization packages, you can use your web browser and get right to coding! Check it out!
